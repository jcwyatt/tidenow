...
with open('/home/pi/pythonsaves/tideproject/tides2016.txt') as fobj:
        for line in fobj:
			lineCounter +=1
			line = line.replace('\n','')
			line = line.replace(' ','')
...
#go through all the times and convert them to dt objects
...
#get the stepper motor to move to indicate tidal change	if change is size of one motor step
